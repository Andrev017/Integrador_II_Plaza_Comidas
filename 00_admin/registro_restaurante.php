...
<body>
    ...
    <section class="section">
        <h1 class="tit_input" >Regsitra de los Restaunrantes</h1>
        <br>
        <form method="post" action="../00_admin/controler_registro_restaurante.php">
            ...
            <br><br>
            <input type="submit" value="Agregar" class="btn_50">
        </form>
    </section>
    <style>
        .tit_input{
    ...
    <section class="contenedores">
        ...
        <form action="./btn_reportes_restaurante.php" method="post">
        ...
        <table class="tabala_crud">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><button class='btn_act' onclick='mostrarModalAct(" . $row["id_res"] .")'>  <img src='./Data/editar_logo.png' alt='' class='img_edit'>  </button> <button class='btn_eli' onclick='mostrarModal(" . $row["id_res"] . ")'>  <img src='./Data/basura_logo.png' alt='' class='img_edit' >  </button></td>";
        ...
        <div class="modal-contenido-actu">
            ...
            <form method="post" action="../00_admin/controllers/actualizar_crud.php">
                ...
                <div class="formm">
                    ...
                    <input type="password" name="descrip" placeholder="Descripción" required>

...
<br><br><br>
    ...
    <div class="pago">
        ...
        <rect fill="white" height="38.1" width="80"></rect>
            ...
            <div>
                <button class="purchase--btn">Generar QR</button>
            </div>
                <div class="separator">
                <hr class="line">
                <p class="linea" >O pagar con tarjeta de credito</p>
                <hr class="line">
            </div>
        <div class="credit-card-info--form">
            <div class="input_container">
                <label for="password_field" class="input_label">Nombre completo del titular de la tarjeta</label>
                <input id="password_field" class="input_field" type="text" name="input-name" title="Inpit title" placeholder="Ingresa tu nombre completo">
            </div>
            <div class="input_container">
                <label for="password_field" class="input_label">Numero de la Tarjeta</label>
                <input id="password_field" class="input_field" type="number" name="input-name" title="Inpit title" placeholder="0000 0000 0000 0000">
            </div>
            <div class="input_container">
                <label for="password_field" class="input_label">Fecha de caducidad / CVV</label>
                <div class="split">
            ...
            <button id="#" class="purchase--btn">Verificar</button>
        </form>
        </div>
        
        <div class="carta_fac">
            <div id="modelo" class="modal">
                ...
                <div class="header">
                    ...
                    <div class="content">
                        <span class="validacion">Compra Validada</span>
                        <p class="message">Gracias por su compra, se le notificara cuando su pedido este listo.</p>
                    </div>
                    <div class="actions">
                        <button class="factura" type="button">Descargar Factura</button>
                        <a href="../View/index.php"><button class="volver" type="button">Volvera a la Plaza</button></a>

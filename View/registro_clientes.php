...
<body>
    <section class="container" >
        ...
        <form action="../Controller/control_registro.php" method="post" onsubmit="return validar(this)" >
            ...
            <span>o <a href="../View/inicio_sesion_clientes.php" class="inicio">Inicio de Sesion</a></span>
            <br><br>
